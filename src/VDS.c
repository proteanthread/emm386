/*
 * vds.asm - --- Jemm's VDS implementation --- Public Domain --- to be assembled with JWasm or Masm v6.1+ (C17 standard)
 *
 * Architectural Role:
...
// .486
// .model FLAT
void vds_handler(void)
{
    /*
     * Mapped logic from vds_handler in VDS.ASM:
...
{
    /*
     * Mapped logic from vds_unsup in VDS.ASM:
     * vds_unsup proc
...
void vds_version(void)
{
    /*
     * Mapped logic from vds_version in VDS.ASM:
     * vds_version proc
...
void vds_reqbuff(void)
{
    /*
     * Mapped logic from vds_reqbuff in VDS.ASM:
     * vds_reqbuff proc
     * 
...
void vds_unlock(void) // fall through
{
    /*
     * Mapped logic from vds_unlock in VDS.ASM:
     * vds_unlock proc
     * 
...
void vds_relbuff(void)
{
    /*
     * Mapped logic from vds_relbuff in VDS.ASM:
     * vds_relbuff proc
     * 
...
{
    /*
     * Mapped logic from testbuffer in VDS.ASM:
     * testbuffer proc
     * 
     *     movzx ebx, [edi].DDS.wID
...
void vds_copyinbuff(void) // fall thru
{
    /*
     * Mapped logic from vds_copyinbuff in VDS.ASM:
     * vds_copyinbuff proc
     * 
     *     cmp dx,0
     *     jnz fail10
...
void vds_copyinbuffEx(void)
{
    /*
     * Mapped logic from vds_copyinbuffEx in VDS.ASM:
...
void vds_copyoutbuff(void) // fall thru
{
    /*
     * Mapped logic from vds_copyoutbuff in VDS.ASM:
...
void vds_copyoutbuffEx(void)
{
    /*
     * Mapped logic from vds_copyoutbuffEx in VDS.ASM:
...
void vds_contiguous(void)
{
    /*
     * Mapped logic from vds_contiguous in VDS.ASM:
     * vds_contiguous proc
     * 
     *     push esi
     *     push edi
...
void vds_contiguous2(void)
{
    /*
     * Mapped logic from vds_contiguous2 in VDS.ASM:
...
{
    /*
     * Mapped logic from vds_lock in VDS.ASM:
     * vds_lock proc
     * 
...
void vds_scatterlock(void)
{
    /*
     * Mapped logic from vds_scatterlock in VDS.ASM:
...
void vds_scatterunlock(void)
{
    /*
     * Mapped logic from vds_scatterunlock in VDS.ASM:
...
void vds_disabletrans(void)
{
    /*
     * Mapped logic from vds_disabletrans in VDS.ASM:
...
void vds_enabletrans(void)
{
    /*
     * Mapped logic from vds_enabletrans in VDS.ASM:
...
{
    /*
     * Mapped logic from VDS_Exit in VDS.ASM:
...
{
    /*
     * Mapped logic from VDS_Init in VDS.ASM:
