/*
 * init.asm - --- Jemm's initialization part --- Public Domain --- to be assembled with JWasm or Masm v6.1+ (C17 standard)
 *
 * Architectural Role:
...
// .486P
// .model FLAT
void RestoreEDI(void)
{
    /*
     * Mapped logic from RestoreEDI in INIT.ASM:
     * RestoreEDI proc
     * 
...
// align 4
void V86_ENDRES(void)
{
    /*
     * Mapped logic from V86_ENDRES in INIT.ASM:
...
void HeapMalloc(void)
{
    /*
     * Mapped logic from HeapMalloc in INIT.ASM:
...
{
    /*
     * Mapped logic from Is486 in INIT.ASM:
     * Is486 proc
     *     pushfd                      ; save EFlags
     *     xor edx,edx
...
{
    /*
     * Mapped logic from SaveIVT in INIT.ASM:
     * SaveIVT proc
...
void SetIDTEntry(void)
{
    /*
     * Mapped logic from SetIDTEntry in INIT.ASM:
     * SetIDTEntry proc
     * if ?SHAREDIDT
...
{
    /*
     * Mapped logic from InitMonitor in INIT.ASM:
...
{
    /*
     * Mapped logic from CopyROM in INIT.ASM:
     * CopyROM proc
     *     pushad
     *     push ecx
     *     mov cl,1
...
{
    /*
     * Mapped logic from IsUMBMemory in INIT.ASM:
