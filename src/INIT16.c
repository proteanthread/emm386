/*
 * init16.asm - --- 16-bit initialization part --- to be assembled with JWasm or Masm v6.1+ (C17 standard)
 *
 * Architectural Role:
...
{
    /*
     * Mapped logic from handle_char in INIT16.ASM:
     * handle_char proc
     * 
     * 	mov dl,al
     * 	cmp al,10
...
{
    /*
     * Mapped logic from ltoa in INIT16.ASM:
...
{
    /*
     * Mapped logic from printf in INIT16.ASM:
...
{
    /*
     * Mapped logic from memcpy in INIT16.ASM:
...
{
    /*
     * Mapped logic from memset in INIT16.ASM:
...
{
    /*
     * Mapped logic from _memicmp in INIT16.ASM:
...
{
    /*
     * Mapped logic from skipWhite in INIT16.ASM:
...
void SetMemoryType(void)
{
    /*
     * Mapped logic from SetMemoryType in INIT16.ASM:
...
void TestForSystemRAM(void)
{
    /*
     * Mapped logic from TestForSystemRAM in INIT16.ASM:
...
void HandleITest(void)
{
    /*
     * Mapped logic from HandleITest in INIT16.ASM:
...
{
    /*
     * Mapped logic from ScanSystemMemory in INIT16.ASM:
...
void LocatePageFrame(void)
{
    /*
     * Mapped logic from LocatePageFrame in INIT16.ASM:
...
void IsUMBMemory(void)
{
    /*
     * Mapped logic from IsUMBMemory in INIT16.ASM:
...
void UMBpageswanted(void)
{
    /*
     * Mapped logic from UMBpageswanted in INIT16.ASM:
...
{
    /*
     * Mapped logic from xmscall in INIT16.ASM:
...
void XMSGetMemoryStatus(void)
{
    /*
     * Mapped logic from XMSGetMemoryStatus in INIT16.ASM:
...
void XMSAllocMemory(void)
{
    /*
     * Mapped logic from XMSAllocMemory in INIT16.ASM:
...
void I15CheckRsvdRegion(void)
{
    /*
     * Mapped logic from I15CheckRsvdRegion in INIT16.ASM:
...
void I15GetMemoryStatus(void)
{
    /*
     * Mapped logic from I15GetMemoryStatus in INIT16.ASM:
     ...
     * 	call I15SetHandle		; set xms block, sizeK in ECX, baseK in EDX
     * _ret:
     * 	@dprintf ?INITRMDBG, <"I15GetMemoryStatus: exit, xms_mem_free=%lX",10>, xms_mem_free
     * 	ret
...
void GetA20Method(void)
{
    /*
     * Mapped logic from GetA20Method in INIT16.ASM:
...
void disable_enable_a20_KBC(void)
{
    /*
     * Mapped logic from disable_enable_a20_KBC in INIT16.ASM:
...
void disable_enable_a20_fast(void)
{
    /*
     * Mapped logic from disable_enable_a20_fast in INIT16.ASM:
...
// 
void disable_enable_a20_BIOS(void)
{
    /*
     * Mapped logic from disable_enable_a20_BIOS in INIT16.ASM:
...
void disable_enable_a20_dummy(void)
{
    /*
     * Mapped logic from disable_enable_a20_dummy in INIT16.ASM:
...
void get_a20_status(void)
{
    /*
     * Mapped logic from get_a20_status in INIT16.ASM:
...
// 
void test_A20_proc(void)
{
    /*
     * Mapped logic from test_A20_proc in INIT16.ASM:
     * test_A20_proc proc
     * 	call get_a20_status
     * 	setnz dl
...
void detect_fast(void)
{
    /*
     * Mapped logic from detect_fast in INIT16.ASM:
     * detect_fast proc
     * 	stc
     * 	mov ax,2403h
     * 	int 15h
...
{
    /*
     * Mapped logic from detect_PS2 in INIT16.ASM:
...
void detect_port92(void)
{
    /*
     * Mapped logic from detect_port92 in INIT16.ASM:
     * detect_port92 proc
     * 
     * 	mov si,OFFSET disable_enable_a20_fast
     * 	call test_A20_proc
...
void detect_BIOS(void)
{
    /*
     * Mapped logic from detect_BIOS in INIT16.ASM:
     * detect_BIOS proc
...
void detect_KBC(void)
{
    /*
     * Mapped logic from detect_KBC in INIT16.ASM:
     * detect_KBC proc
     * 
...
{
    /*
     * Mapped logic from InitA20 in INIT16.ASM:
...
void AllocAndInitMem(void)
{
    /*
     * Mapped logic from AllocAndInitMem in INIT16.ASM:
...
{
    /*
     * Mapped logic from toupper in INIT16.ASM:
     * toupper PROC
     * 	pop cx
     * 	pop ax
     * 	push cx
...
void NotInstalled(void)
{
    /*
     * Mapped logic from NotInstalled in INIT16.ASM:
     * NotInstalled proc
...
void IsJemmInstalled(void)
{
    /*
     * Mapped logic from IsJemmInstalled in INIT16.ASM:
...
{
    /*
     * Mapped logic from TryUnload in INIT16.ASM:
...
{
    /*
     * Mapped logic from EmmStatus in INIT16.ASM:
...
{
    /*
     * Mapped logic from EmmUpdate in INIT16.ASM:
...
void IsEmmInstalled(void)
{
    /*
     * Mapped logic from IsEmmInstalled in INIT16.ASM:
...
{
    /*
     * Mapped logic from GetValue in INIT16.ASM:
...
{
    /*
     * Mapped logic from FindCommand in INIT16.ASM:
...
void VMwareDetect(void)
{
    /*
     * Mapped logic from VMwareDetect in INIT16.ASM:
     * VMwareDetect proc c
     * 
...
{
    /*
     * Mapped logic from DisplayMemoryMap in INIT16.ASM:
...
{
    /*
     * Mapped logic from cprintf in INIT16.ASM:
...
void IsProtectedMode(void)
{
    /*
     * Mapped logic from IsProtectedMode in INIT16.ASM:
...
{
    /*
     * Mapped logic from IsDPMI in INIT16.ASM:
...
void disp_xbda_size(void)
{
    /*
     * Mapped logic from disp_xbda_size in INIT16.ASM:
...
{
    /*
     * Mapped logic from hascpuid in INIT16.ASM:
     * hascpuid proc
     * 	push di
     * 	mov di,sp
...
{
    /*
     * Mapped logic from mainex in INIT16.ASM:
