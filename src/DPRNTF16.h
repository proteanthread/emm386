/*
 * dprntf16.inc - --- printf for debug displays, 16-bit --- itoa(long n, char * s, int base); --- convert 32-bit long to string --- v5.86: removed eax from uses clause (since AX is used to return string ptr) (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart header representing DPRNTF16.INC.
 *
...
static inline void ltoa(void)
{
    /*
     * Mapped logic from ltoa in DPRNTF16.INC:
...
{
    /*
     * Mapped logic from dprintf in DPRNTF16.INC:
