/*
 * ems.asm - --- EMS implementation --- EMS 4.0 is Public Domain, originally written by Michael Devore, --- extended and modified for Jemm by Japheth --- the EMS 3.2 part is copyrighted and has therefore --- been moved into a separate include file (EMS32.INC) --- to be assembled with JWasm or Masm v6.1+ (C17 standard)
 *
 * Architectural Role:
...
#include <jemm.h> // common declarations
#include <jemm32.h> // declarations for Jemm32
#include <debug.h>
#include <ems.h>

// --- equates

#define DEVICE_NAME 000Ah // offset device name in RSEG

// --- assembly time constants

#define ?MAXPHYSPG 56 // std=56, max physical pages (don't set below 4!)
#define ?YIELDOPEN 0 // std=0, 1=yield on handle open
#define ?LIM32 0 // std=0, 1=support LIM EMS 3.2 only
#define ?SUPP5B 1 // std=1, 1=support int 67h, ax=5Bxxh

// --- EMS specific constants

void Int67_V86Entry(void)
{
    /*
     * Mapped logic from Int67_V86Entry in EMS.ASM:
...
void Int67_Entry(void)
{
    /*
     * Mapped logic from Int67_Entry in EMS.ASM:
     ...
     *     MOV ES,ECX
     * 
     *     @dprintf ?V86DBG, <"Int 67h in v86-mode, CS:EIP=%X:%X EBP=%X AX=%X",10>, [ebp].Client_Reg_Struc.Client_CS, [ebp].Client_Reg_Struc.Client_EIP, ebp, ax
     * 
     *     mov ecx,[dwRSeg]
...
#include <EMS32.h> // include the copyrighted part (EMS 3.2)
...
void EMS_MAP_REL_PAGE(void) // fall thru!!!
{
    /*
     * Mapped logic from EMS_MAP_REL_PAGE in EMS.ASM:
...
void EMS_MAP_ABS_PAGE(void) // fall through!!!
{
    /*
     * Mapped logic from EMS_MAP_ABS_PAGE in EMS.ASM:
...
void EMS_MAP_ABS_PAGE_EX(void)
{
    /*
     * Mapped logic from EMS_MAP_ABS_PAGE_EX in EMS.ASM:
...
{
    /*
     * Mapped logic from FlushTLB in EMS.ASM:
     * FlushTLB proc
     * if 0
     *     cmp [bNoInvlPg],0
     *     jz @@noinvlpg
...
void EMS_get_abs_page(void)
{
    /*
     * Mapped logic from EMS_get_abs_page in EMS.ASM:
...
void EMS_Segm2Phys(void)
{
    /*
     * Mapped logic from EMS_Segm2Phys in EMS.ASM:
     * EMS_Segm2Phys proc
...
void ems4_get_set_partial_page_map(void)
{
    /*
     * Mapped logic from ems4_get_set_partial_page_map in EMS.ASM:
...
void ems4_map_multiple(void)
{
    /*
     * Mapped logic from ems4_map_multiple in EMS.ASM:
...
// 
void ems4_realloc(void)
{
    /*
     * Mapped logic from ems4_realloc in EMS.ASM:
     * ems4_realloc PROC
     * 
...
void ems4_attribute(void)
{
    /*
     * Mapped logic from ems4_attribute in EMS.ASM:
     * ems4_attribute PROC
     *     cmp al,2
...
// DX = handle
// 
void ems4_get_set_handle_name(void)
{
    /*
     * Mapped logic from ems4_get_set_handle_name in EMS.ASM:
...
void ems4_get_handle_info(void)
{
    /*
     * Mapped logic from ems4_get_handle_info in EMS.ASM:
...
void ems4_map_new_pagemap(void)
{
    /*
     * Mapped logic from ems4_map_new_pagemap in EMS.ASM:
...
void ems4_alter_map_jump(void)
{
    /*
     * Mapped logic from ems4_alter_map_jump in EMS.ASM:
...
void ems4_alter_map_call(void)
{
    /*
     * Mapped logic from ems4_alter_map_call in EMS.ASM:
...
#define RegionSrc <ebp.Client_Reg_Struc.Client_Error>
#define pPTE <ebp-4>
#define regSize <ebp-8>
#define linAddr <ebp-12>

void ems4_move_memory(void)
{
    /*
     * Mapped logic from ems4_move_memory in EMS.ASM:
...
void ems4_get_mappable_info(void)
{
    /*
     * Mapped logic from ems4_get_mappable_info in EMS.ASM:
...
void ems4_get_config(void)
{
    /*
     * Mapped logic from ems4_get_config in EMS.ASM:
...
// out DX = handle
// 
void ems4_allocate_pages(void)
{
    /*
     * Mapped logic from ems4_allocate_pages in EMS.ASM:
...
void ems4_alt_map_reg_set(void)
{
    /*
     * Mapped logic from ems4_alt_map_reg_set in EMS.ASM:
...
void GetFreeEMSPages(void)
{
    /*
     * Mapped logic from GetFreeEMSPages in EMS.ASM:
...
void AllocateEMSPage(void)
{
    /*
     * Mapped logic from AllocateEMSPage in EMS.ASM:
...
void AllocateEMSPages(void)
{
    /*
     * Mapped logic from AllocateEMSPages in EMS.ASM:
...
void ReleaseEMSPage(void)
{
    /*
     * Mapped logic from ReleaseEMSPage in EMS.ASM:
     * ReleaseEMSPage  PROC
     *     push eax
     *     push ecx
     *     push edx
...
void SetEMSHandleTable(void)
{
    /*
     * Mapped logic from SetEMSHandleTable in EMS.ASM:
...
void SetEMSStateTable(void)
{
    /*
     * Mapped logic from SetEMSStateTable in EMS.ASM:
...
void SetEMSNameTable(void)
{
    /*
     * Mapped logic from SetEMSNameTable in EMS.ASM:
...
{
    /*
     * Mapped logic from EMS_Init1 in EMS.ASM:
...
{
    /*
     * Mapped logic from EMS_Init2 in EMS.ASM:
...
void EMS_CheckMax(void)
{
    /*
     * Mapped logic from EMS_CheckMax in EMS.ASM:
