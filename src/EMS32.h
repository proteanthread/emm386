/*
 * ems32.inc - --- this is the Jemm EMS 3.2 implementation (functions 40h - 4Eh) --- since this part is copyright Harald Albrecht/Tom Ehlert, --- it has been extracted into a separate file. --- It's included by EMS.ASM --- API: EBP -> client registers --- out: BX, DX and AH will be copied to client registers --- change of other registers have to be done directly AH = 40h: return the actual state of the EMM-driver. (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart header representing EMS32.INC.
 *
...
static inline void EMS_GET_STATUS(void)
{
    /*
     * Mapped logic from EMS_GET_STATUS in EMS32.INC:
     * EMS_GET_STATUS PROC
     *     MOV     AH,EMSS_OK
     *     RET
     * EMS_GET_STATUS ENDP
...
// 
static inline void EMS_GET_PAGE_FRAME_ADDRESS(void)
{
    /*
     * Mapped logic from EMS_GET_PAGE_FRAME_ADDRESS in EMS32.INC:
...
static inline void EMS_GET_UNALLOCATED_PAGE_COUNT(void)
{
    /*
     * Mapped logic from EMS_GET_UNALLOCATED_PAGE_COUNT in EMS32.INC:
...
static inline void EMS_ALLOCATE_PAGES(void)
{
    /*
     * Mapped logic from EMS_ALLOCATE_PAGES in EMS32.INC:
...
// 
static inline void EMS_MAP_HANDLE_PAGE(void)
{
    /*
     * Mapped logic from EMS_MAP_HANDLE_PAGE in EMS32.INC:
...
static inline void EMS_DEALLOCATE_PAGES(void)
{
    /*
     * Mapped logic from EMS_DEALLOCATE_PAGES in EMS32.INC:
...
static inline void EMS_GET_VERSION(void)
{
    /*
     * Mapped logic from EMS_GET_VERSION in EMS32.INC:
...
static inline void EMS_SaveFrameToEdi(void) // fall through
{
    /*
     * Mapped logic from EMS_SaveFrameToEdi in EMS32.INC:
...
static inline void EMS_SavePagesToEdi(void)
{
    /*
     * Mapped logic from EMS_SavePagesToEdi in EMS32.INC:
...
static inline void EMS_RestoreFrameFromEsi(void) // fall through
{
    /*
     * Mapped logic from EMS_RestoreFrameFromEsi in EMS32.INC:
...
static inline void EMS_RestorePagesFromEsi(void)
{
    /*
     * Mapped logic from EMS_RestorePagesFromEsi in EMS32.INC:
...
// 
static inline void EMS_SAVE_PAGES(void)
{
    /*
     * Mapped logic from EMS_SAVE_PAGES in EMS32.INC:
     * EMS_SAVE_PAGES PROC
...
static inline void EMS_RESTORE_PAGES(void)
{
    /*
     * Mapped logic from EMS_RESTORE_PAGES in EMS32.INC:
...
static inline void EMS_NOT_IMPL(void)
{
    /*
     * Mapped logic from EMS_NOT_IMPL in EMS32.INC:
     * EMS_NOT_IMPL PROC
     * 
...
static inline void EMS_GET_OPEN_HANDLES_COUNT(void)
{
    /*
     * Mapped logic from EMS_GET_OPEN_HANDLES_COUNT in EMS32.INC:
...
static inline void EMS_GET_PAGES_ONE_HANDLE(void)
{
    /*
     * Mapped logic from EMS_GET_PAGES_ONE_HANDLE in EMS32.INC:
...
// 
static inline void EMS_GET_PAGES_ALL_HANDLES(void)
{
    /*
     * Mapped logic from EMS_GET_PAGES_ALL_HANDLES in EMS32.INC:
...
static inline void EMS_GET_SET_PAGE_MAP(void)
{
    /*
     * Mapped logic from EMS_GET_SET_PAGE_MAP in EMS32.INC:
...
static inline void EMS_TEST_HANDLE(void)
{
    /*
     * Mapped logic from EMS_TEST_HANDLE in EMS32.INC:
