/*
 * findres.inc - Interface mapping for FINDRES.INC (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart header representing FINDRES.INC.
 *
...
#define ?NOCASEMAP 0 // win32 std is 0
...
static inline void ScanResDir(void)
{
    /*
     * Mapped logic from ScanResDir in FINDRES.INC:
...
static inline void FindResourceA(void)
{
    /*
     * Mapped logic from FindResourceA in FINDRES.INC:
...
static inline void FindResourceExA(void)
{
    /*
     * Mapped logic from FindResourceExA in FINDRES.INC:
...
static inline void LoadResource(void)
{
    /*
     * Mapped logic from LoadResource in FINDRES.INC:
...
static inline void LockResource(void)
{
    /*
     * Mapped logic from LockResource in FINDRES.INC:
...
{
    /*
     * Mapped logic from FreeResource in FINDRES.INC:
...
static inline void SizeofResource(void)
{
    /*
     * Mapped logic from SizeofResource in FINDRES.INC:
