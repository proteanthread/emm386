/*
 * testiot.asm - --- tsr to test JLM IOTRAP. --- it installs a callback which is called whenever port 100h --- is accessed. --- the callback displays some colored characters on line 25. --- assemble: JWasm -bin -Fo testiot.com testiot.asm (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing TESTIOT.ASM.
 *
