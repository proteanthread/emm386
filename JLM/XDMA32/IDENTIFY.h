/*
 * identify.inc - --- data returned by Identify Device from ATA disks --- it's 256 * 16-bit words. (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart header representing IDENTIFY.INC.
 *
...
// endif
#define MultiSectorSettingValid 0
// SupportedFlags db ?
...
// } AdditionalSupported // 
// endif
#define ExtendedUserAddressableSectorsSupported 3
