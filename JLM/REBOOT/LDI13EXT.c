/*
 * ldi13ext.asm - --- sample how to load an int 13h extension into FASTBOOT JLM. --- this sample just swaps HDs 0 and 1 in int 13h; int 41h/46h are NOT modified. --- assemble: JWasm -mz LDI13EXT.asm (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing LDI13EXT.ASM.
 *
...
{
    /*
     * Mapped logic from int13ext in LDI13EXT.ASM:
     * int13ext proc
     * 
     * 	push es
     * 	pusha
...
{
    /*
     * Mapped logic from main in LDI13EXT.ASM:
     * main proc
     * 
     * local dwFB:dword
     * 
...
{
    /*
     * Mapped logic from lfout in LDI13EXT.ASM:
     * lfout proc
     * 	mov dx,DStr(13,10)
     * 	mov ah,9
     * 	int 21h
