/*
 * testqpi.asm - --- test Qemm/QPIEMU ( IO trap part ) (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing TESTQPI.ASM.
 *
...
{
    /*
     * Mapped logic from myio in TESTQPI.ASM:
     * myio proc far
     * 	pusha
     * 	mov bp, sp
     * 	push ds
...
{
    /*
     * Mapped logic from main in TESTQPI.ASM:
