/*
 * testdma.asm - --- test Qemm/QPIEMU ( IO trap part ) --- this time test ISA DMA ports (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing TESTDMA.ASM.
 *
...
#include <printf16.h> // this printf() preserves all registers!
...
{
    /*
     * Mapped logic from myio in TESTDMA.ASM:
     * myio proc far
     * 	pusha
     * 	mov bp, sp
     * 	push ds
...
{
    /*
     * Mapped logic from main in TESTDMA.ASM:
