/*
 * printf16.inc - --- simple printf() implementation (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart header representing PRINTF16.INC.
 *
...
static inline void handle_char(void)
{
    /*
     * Mapped logic from handle_char in PRINTF16.INC:
     * handle_char proc
     * 
     * 	mov dl,al
     * 	cmp al,10
...
static inline void ltob(void)
{
    /*
     * Mapped logic from ltob in PRINTF16.INC:
...
static inline void printf(void)
{
    /*
     * Mapped logic from printf in PRINTF16.INC:
