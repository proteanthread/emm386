/*
 * jclock3.asm - --- JCLOCK2 in Masm/JWasm syntax (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing JCLOCK3.ASM.
 *
...
// 1. Addresses
#define DispMode 000449h // BYTE  - display mode
#define ColNum 00044Ah // WORD  - number of columns
#define Timer 00046Ch // DWORD - timer of BIOS
#define CoVideo 0B8000h // Video buffer offset for MODE CO80/CO40
#define MoVideo 0B0000h // Video buffer offset for MODE MONO
...
{
    /*
     * Mapped logic from  in JCLOCK3.ASM:
     * hookproc endp
     */
}
...
// 
void printBCDcell(void)
{
    /*
     * Mapped logic from printBCDcell in JCLOCK3.ASM:
     * printBCDcell proc
...
{
    /*
     * Mapped logic from install in JCLOCK3.ASM:
     * install proc
     * 
     * 	mov eax,intn
     * 	mov esi,hookproc
...
{
    /*
     * Mapped logic from deinstall in JCLOCK3.ASM:
     * deinstall proc
     * 
     * 	mov eax,intn
     * 	mov esi,hookproc
...
// DLL entry point
// 
void DllEntryPoint(void)
{
    /*
     * Mapped logic from DllEntryPoint in JCLOCK3.ASM:
