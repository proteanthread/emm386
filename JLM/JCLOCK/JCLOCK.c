/*
 * jclock.asm - JCLOCK 1.1 JLM example -- CLOCK for JEMM386/JEMMEX It is the first JLM with screen input/output :-) (C) 2007 Alexey Voskov Compile with FASM for WIN32 and change PE signature into PX (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing JCLOCK.ASM.
 *
