/*
 * generic.asm - --- JLM sample GENERIC --- use Makefile to create GENERIC.DLL --- GENERIC is a very simple JLM. It doesn't hook v86-interrupt vectors. --- To be called from v86-mode, its entry point must be obtained by the --- caller. (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing GENERIC.ASM.
 *
...
{
    /*
     * Mapped logic from v86_dispatch in GENERIC.ASM:
     * v86_dispatch proc
     * 
...
{
    /*
     * Mapped logic from getversion in GENERIC.ASM:
     * getversion proc
     * 
...
{
    /*
     * Mapped logic from display_hello in GENERIC.ASM:
...
{
    /*
     * Mapped logic from install in GENERIC.ASM:
...
{
    /*
     * Mapped logic from deinstall in GENERIC.ASM:
...
{
    /*
     * Mapped logic from DllMain in GENERIC.ASM:
