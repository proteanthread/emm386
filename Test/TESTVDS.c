/*
 * testvds.asm - --- VDS API test --- 8103/8104: lock/unlock region --- 8107/8108/8109/810A: request/release DMA buffer, copy into/out of DMA buffer --- 8105/8106 scatter/gather lock/unlock (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing TESTVDS.ASM.
 *
...
void RsvdFunction(void)
{
    /*
     * Mapped logic from RsvdFunction in TESTVDS.ASM:
     * RsvdFunction proc
     * 
...
{
    /*
     * Mapped logic from LockUnlock in TESTVDS.ASM:
     * LockUnlock proc
     * 
     * local bFail:byte
     * 
...
{
    /*
     * Mapped logic from DMABuffer in TESTVDS.ASM:
     * DMABuffer proc
     * 
     * local bFail:byte
     * 
...
void ScatterGather(void)
{
    /*
     * Mapped logic from ScatterGather in TESTVDS.ASM:
     * ScatterGather proc
     * 
...
{
    /*
     * Mapped logic from main in TESTVDS.ASM:
     * main proc c
     * 
     * local	version:word
     * local	product:word
