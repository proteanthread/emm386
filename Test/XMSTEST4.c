/*
 * xmstest4.asm - --- XMSTEST4: test block resize (shrink) --- Public Domain. --- to be assembled with JWasm or Masm v6. (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing XMSTEST4.ASM.
 *
...
{
    /*
     * Mapped logic from testproc in XMSTEST4.ASM:
     * testproc proc
     * 
     * local handle:word
     * 
...
{
    /*
     * Mapped logic from main in XMSTEST4.ASM:
     * main    proc c
     * 
     * 	mov ax,4300h
     * 	int 2fh
...
{
    /*
     * Mapped logic from start in XMSTEST4.ASM:
     * start   proc
     * 
     * 	mov ax,@data
     * 	mov ds,ax
