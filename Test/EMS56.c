/*
 * ems56.asm - *** test int 67h, ah=56h (alter map and call) (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing EMS56.ASM.
 *
...
{
    /*
     * Mapped logic from main in EMS56.ASM:
...
{
    /*
     * Mapped logic from testpr in EMS56.ASM:
     * testpr proc far
     * 	mov ah,02
     * 	mov dl,'*'
     * 	int 21h
