/*
 * xmstest2.asm - --- XMSTEST2: test max block allocation --- Public Domain. --- to be assembled with JWasm or Masm v6. (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing XMSTEST2.ASM.
 *
...
{
    /*
     * Mapped logic from movetest in XMSTEST2.ASM:
     * movetest proc
     * 
     * local handle:word
     * local maxmem:dword
...
{
    /*
     * Mapped logic from main in XMSTEST2.ASM:
     * main    proc c
     * 
     * 	mov ax,4300h
     * 	int 2fh
...
{
    /*
     * Mapped logic from start in XMSTEST2.ASM:
     * start   proc
     * 
     * 	mov ax,@data
     * 	mov ds,ax
