/*
 * ems57.asm - *** EMS move (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing EMS57.ASM.
 *
...
#define ?BUFSIZE 10000h
#define ?SIZE ?BUFSIZE/4000h // size in EMS pages
...
{
    /*
     * Mapped logic from main in EMS57.ASM:
     * main proc c
     * 
     * local handle:word
     * local wPages:word
