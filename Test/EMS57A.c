/*
 * ems57a.asm - *** test EMS move (int 67h, ah=57h) *** move 1024 kB conv to EMS memory *** move 1024 kB EMS to EMS memory non-overlapping *** move 1024 kB EMS to EMS memory overlapping (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing EMS57A.ASM.
 *
...
#define ?SIZE 64 // size in EMS pages (64*16=1024 kB)
...
{
    /*
     * Mapped logic from main in EMS57A.ASM:
     * main proc c
     * 
     * local handle:word
     * local wPages:word
