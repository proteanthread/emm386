/*
 * ems4e.asm - *** test EMS get/set page map (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing EMS4E.ASM.
 *
...
{
    /*
     * Mapped logic from EMScheck in EMS4E.ASM:
...
{
    /*
     * Mapped logic from main in EMS4E.ASM:
     * main proc c
     * 
     * local handle:word
     * 
