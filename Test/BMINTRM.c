/*
 * bmintrm.asm - --- benchmark *** call int 69h a number of times and count timer ticks (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing BMINTRM.ASM.
 *
...
{
    /*
     * Mapped logic from main in BMINTRM.ASM:
     * main proc c
     * 
     * local	dwStart:dword
     * local	rmvec:dword
