/*
 * testvds2.asm - --- VDS API test; test disable/enable auto DMA translation (810B/810C) (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing TESTVDS2.ASM.
 *
...
{
    /*
     * Mapped logic from main in TESTVDS2.ASM:
     * main proc c
     * 
     * local	channel:word
     * 
