/*
 * vioout.inc - --- low-level video access --- no assumption about ds,es. --- ss is supposed to be flat. (C17 standard)
 *
 * Architectural Role:
...
static inline void VPUTCHR(void)
{
    /*
     * Mapped logic from VPUTCHR in VIOOUT.INC:
     * VPUTCHR PROC
     * 	push ds
     * 	pushad
     * 	push ss
