/*
 * memstat.asm - *** get extended memory status using int 15h *** AH=88h *** AH=C7h if supported *** AX=E801h *** AX=E820h (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing MEMSTAT.ASM.
 *
...
{
    /*
     * Mapped logic from conv_mem in MEMSTAT.ASM:
     * conv_mem proc
     * 	int 12h
...
{
    /*
     * Mapped logic from do_c0c7 in MEMSTAT.ASM:
     * do_c0c7 proc
     * 	stc
     * 	mov ah,0C0h
     * 	int 15h
...
{
    /*
     * Mapped logic from do_88 in MEMSTAT.ASM:
     * do_88 proc
     * 	clc
     * 	mov ax,8800h
     * 	int 15h
...
{
    /*
     * Mapped logic from do_e801 in MEMSTAT.ASM:
     * do_e801 proc
     * 	xor cx,cx
     * 	xor dx,dx
     * 	xor bx,bx
...
{
    /*
     * Mapped logic from do_e820 in MEMSTAT.ASM:
     * do_e820 proc
     * 	push ds
     * 	pop es
     * 	mov si,0
...
{
    /*
     * Mapped logic from xbda in MEMSTAT.ASM:
     * xbda proc
     * 	push 40h
     * 	pop es
     * 	mov ax,es:[000Eh]
...
{
    /*
     * Mapped logic from main in MEMSTAT.ASM:
     * main proc c
     * 
     * 	call conv_mem
     * 	call xbda
