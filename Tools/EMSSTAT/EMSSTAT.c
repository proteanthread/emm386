/*
 * emsstat.asm - --- EMSSTAT: display EMS status. --- Public Domain. --- tools: JWasm/Masm v6 and WLink. (C17 standard)
 *
 * Architectural Role:
 *   Serves as the C counterpart source representing EMSSTAT.ASM.
 *
...
{
    /*
     * Mapped logic from EMScheck in EMSSTAT.ASM:
...
{
    /*
     * Mapped logic from getpar in EMSSTAT.ASM:
     * getpar proc near
     * 	mov bx,0080h
     * 	mov cl,es:[bx]
     * 	cmp cl,00
...
{
    /*
     * Mapped logic from main in EMSSTAT.ASM:
     * main proc c
     * 
     * 	call getpar
     * 	jc exit
...
{
    /*
     * Mapped logic from readd in EMSSTAT.ASM:
     * readd proc near
     * 	mov ax,4100h
     * 	call intrt
...
{
    /*
     * Mapped logic from rpages in EMSSTAT.ASM:
     * rpages proc
     * 	mov ax,5901h
     * 	int 67h
     * 	cmp ah,0
...
{
    /*
     * Mapped logic from xvhandle in EMSSTAT.ASM:
     * xvhandle proc near
     * 
     * local	wHandles:WORD
     * 
...
{
    /*
     * Mapped logic from searchpage in EMSSTAT.ASM:
     * searchpage proc
     * 	push di
     * @@:
     * 	cmp si,[di]
...
{
    /*
     * Mapped logic from ppages in EMSSTAT.ASM:
     * ppages proc c
     * 
     * local	count:word
     * local	numpgs:word
...
{
    /*
     * Mapped logic from intrt in EMSSTAT.ASM:
     * intrt proc near
     * 	mov fc,ax
     * 	int 67h
     * 	and ah,ah
...
{
    /*
     * Mapped logic from descout in EMSSTAT.ASM:
     * descout proc near
...
{
    /*
     * Mapped logic from vcpi in EMSSTAT.ASM:
     * vcpi proc near
     * 
     * 	mov ax,4300h
...
{
    /*
     * Mapped logic from read0 in EMSSTAT.ASM:
     * read0 proc
     * 	push cx
...
{
    /*
     * Mapped logic from deviceinfo in EMSSTAT.ASM:
     * deviceinfo proc
